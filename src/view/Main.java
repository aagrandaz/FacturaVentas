...
public class Main extends Application {
    ...
    public static TreeItem<String> iniciarItems() {
        ImageView iconCliente = new ImageView(
                new Image(Main.class.getResourceAsStream("/view/img/clientes.png"))
        );
        ...
        ImageView iconArticulo = new ImageView(
                new Image(Main.class.getResourceAsStream("/view/img/articulos.png"))
        );
        ...
        ImageView iconFactura = new ImageView(
                new Image(Main.class.getResourceAsStream("/view/img/facturas.png"))
        );
        ...
        ImageView iconComprar = new ImageView(
                new Image(Main.class.getResourceAsStream("/view/img/comprar.png"))
        );
    ...
    public void start(Stage primaryStage) throws IOException {
        primaryStage.getIcons().add(new Image("view/img/main.png"));
